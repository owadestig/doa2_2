...
class Graph(object):
    ...
    def set_capacity(self, u: str, v: str, capacity: Union[int, None]) -> None:
        ...
        Pre: the capacity is positive. The node u, the node v, and the edge
             (u, v) exists is in the graph
        Post:
    ...
    def set_flow(self, u: str, v: str, flow: Union[int, None]) -> None:
        ...
        Pre: The flow is non-negative. the node u, the node v, and the edge
             (u, v) exists is in the graph
        Post:
